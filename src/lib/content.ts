...
export const practiceAreas = [
  ...
  },
  {
    ...
    summary: "We build leaders with sharper judgment, presence, and the courage to lead change.",
    description:
  ...
  },
  {
    ...
    summary: "Convene, inspire, and move: summits that turn big ideas into shared momentum.",
    description:
